      ...
      <div className="container mx-auto px-6">
        <div className="relative overflow-hidden glass-dark text-white rounded-[2.5rem] p-10 md:p-16 lg:p-20">
          ...
          <div className="relative max-w-3xl">
            ...
            <Link href={href} className="mt-10 inline-flex items-center gap-2 px-7 py-4 bg-white text-[#312e81] rounded-full text-sm hover:bg-[#a5b4fc] transition-all group">
              {buttonLabel}
